...
public class CompleteProfileViewModel extends ViewModel {
    ...
    public void completeUserProfile(UserModel userModel){
        ...
        firebaseRepository.getIdToken(new FirebaseRepository.IdTokenCallback() {
            @Override
            public void onTokenReceived(String token) {
                completeUserProfileUseCase.execute(token, userModel).observeForever(resource -> {
            ...
            public void onError(String error) {
                completeUserProfileViewState.setValue(CompleteProfileViewState.error("Error obteniendo token: " + error));
            }
        });
    }
